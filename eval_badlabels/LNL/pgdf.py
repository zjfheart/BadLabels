"""
Original Code is from https://github.com/bupt-ai-cz/PGDF
"""
...
import loader.pgdf_dataloader as dataloader
from generic.utils import pgdf_parse_args, his_dataset
sys.path.append("..")
...
if __name__ == "__main__":
    args = pgdf_parse_args("config/presets.json")
    print(args)
    ...
    def train(epoch, net, net2, optimizer, labeled_trainloader, unlabeled_trainloader, easy_trainloader):
        ...
        if epoch > 150:
            ...
            temp_prob_trans_m = temp_prob_trans_m / torch.sum(temp_prob_trans_m,dim=1, keepdim=True).add(1e-10)
    ...
    loader_easy = dataloader.easy_dataloader(
        dataset=args.dataset,
        r=args.r,
        noise_mode=args.noise_mode,
        batch_size=args.batch_size,
